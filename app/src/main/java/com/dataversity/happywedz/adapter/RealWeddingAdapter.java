...
public class RealWeddingAdapter extends RecyclerView.Adapter<RealWeddingAdapter.ChildViewHolder> {

   // private List<FranchiseWasherResponsePojo> ChildItemList;
    Context context;

    // Constuctor
    public RealWeddingAdapter(Context context)
    {
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.real_wedding_child_item, viewGroup, false);

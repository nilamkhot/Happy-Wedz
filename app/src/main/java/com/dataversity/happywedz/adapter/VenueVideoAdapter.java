...
public class VenueVideoAdapter extends RecyclerView.Adapter<VenueVideoAdapter.ChildViewHolder> {

   // private List<FranchiseWasherResponsePojo> ChildItemList;
    Context context;

    // Constuctor
    public VenueVideoAdapter(Context context)
    {
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.video_child_item, viewGroup, false);

...
public class GenieServiceAdapter extends RecyclerView.Adapter<GenieServiceAdapter.ChildViewHolder> {

   // private List<FranchiseWasherResponsePojo> ChildItemList;
    Context context;

    // Constuctor
    public GenieServiceAdapter(Context context)
    {
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.genie_serivce_child_item, viewGroup, false);

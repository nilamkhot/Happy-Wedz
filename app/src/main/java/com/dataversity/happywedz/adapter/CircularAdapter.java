...
public class CircularAdapter extends RecyclerView.Adapter<CircularAdapter.ChildViewHolder> {
   ...
   // private List<FranchiseWasherResponsePojo> ChildItemList;
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.circular_child_item, viewGroup, false);

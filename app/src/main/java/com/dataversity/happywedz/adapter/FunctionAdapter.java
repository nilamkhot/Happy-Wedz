...
import com.dataversity.happywedz.ShopBrowseActivity;

import androidx.annotation.NonNull;
import androidx.recyclerview.widget.RecyclerView;

public class FunctionAdapter extends RecyclerView.Adapter<FunctionAdapter.ChildViewHolder> {
   ...
   // private List<FranchiseWasherResponsePojo> ChildItemList;
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.function_child_item, viewGroup, false);
    ...
    {
        childViewHolder.linear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, ShopBrowseActivity.class);

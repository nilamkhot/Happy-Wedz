...
public class IdeaRealAdapter extends RecyclerView.Adapter<IdeaRealAdapter.ChildViewHolder> {

   // private List<FranchiseWasherResponsePojo> ChildItemList;
    Context context;

    // Constuctor
    public IdeaRealAdapter(Context context)
    {
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.idea_real_child_item, viewGroup, false);

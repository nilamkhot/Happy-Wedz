...
public class Filter_SubType_Adapter extends RecyclerView.Adapter<Filter_SubType_Adapter.ChildViewHolder> {

    String[] list;
    Context context;

    // Constuctor
    public Filter_SubType_Adapter(Context context, String[] list)
    {
        this.list = list;
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.filter_subtype_child_item, viewGroup, false);

...
public class InterestingAdapter extends RecyclerView.Adapter<InterestingAdapter.ChildViewHolder> {
   ...
   // private List<FranchiseWasherResponsePojo> ChildItemList;
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.interesting_child_item, viewGroup, false);

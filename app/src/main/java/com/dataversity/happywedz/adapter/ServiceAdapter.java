...
public class ServiceAdapter extends RecyclerView.Adapter<ServiceAdapter.ChildViewHolder> {
   ...
   // private List<FranchiseWasherResponsePojo> ChildItemList;
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.service_child_item, viewGroup, false);

...
public class OutfitAdapter extends RecyclerView.Adapter<OutfitAdapter.ChildViewHolder> {
   ...
   // private List<FranchiseWasherResponsePojo> ChildItemList;
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.outfit_child_item, viewGroup, false);

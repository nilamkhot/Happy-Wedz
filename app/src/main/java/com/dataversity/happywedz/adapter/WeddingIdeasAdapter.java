...
public class WeddingIdeasAdapter extends RecyclerView.Adapter<WeddingIdeasAdapter.ChildViewHolder> {

   // private List<FranchiseWasherResponsePojo> ChildItemList;
    Context context;

    // Constuctor
    public WeddingIdeasAdapter(Context context)
    {
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.wedding_ideas_child_item, viewGroup, false);
